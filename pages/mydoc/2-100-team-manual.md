...
1. Add Team Member’s account ID at the bottom of the page and then assign license quantity for each added member
...
1. Team Members need to check ‘Email Verification’ before using the software
...
1. Note: Distinct role of Team Admin / Team Maintainer
